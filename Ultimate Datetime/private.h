...
// The following 5 added for Windows port
//#define mktime sys_mktime
//#define ctime sys_ctime
//#define gmtime sys_gmtime
//#define localtime sys_localtime
//#define asctime sys_asctime
//
#include <time.h>
#undef localtime_rz
#undef mktime_z
...
DLLExport struct tm *localtime_rz(timezone_t restrict, time_t const *restrict,
			struct tm *restrict);
DLLExport time_t mktime_z(timezone_t restrict, struct tm *restrict);
DLLExport timezone_t tzalloc(char const *);
DLLExport void tzfree(timezone_t);
# ifdef STD_INSPIRED
...
char *		icatalloc(char * old, const char * anew);
