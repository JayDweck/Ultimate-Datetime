...
static struct tm *gmtsub(struct state const *, time_t const *, int_fast32_t,
			 struct tm *);
static bool increment_overflow(int *const, int);
static bool increment_overflow_time(time_t *, int_fast32_t);
static bool normalize_overflow32(int_fast32_t *const, int *const, const int);
static struct tm *timesub(time_t  const *, const int_fast32_t, const struct state *const,
	struct tm *const);

//static struct tm *timesub(time_t const *, int_fast32_t, struct state const *,
//			  struct tm *);
static bool typesequiv(const struct state * const, const int, const int);
static bool tzparse(char const *, struct state *const, bool);
...
{
  timezone_t sp = (timezone_t)malloc(sizeof *sp);
  if (sp) {
...
struct tm *
tZlocaltime(const time_t *const timep)
{
...
struct tm *
tZgmtime(const time_t *const timep)
{
...
static struct tm *
timesub(const time_t * timep, const int_fast32_t offset,
...
char *
tZctime(const time_t *const timep)
{
/*
** Section 4.12.3.2 of X3.159-1989 requires that
**	The tZctime function converts the calendar time pointed to by timer
**	to local time in the form of a string. It is equivalent to
**		asctime(localtime(timer))
*/
  struct tm *tmp = tZlocaltime(timep);
...
time_t
mktime_z(timezone_t sp, struct tm *tmp)
{
